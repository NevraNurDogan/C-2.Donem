...
/*8. Kullanıcının istediği sıradaki elemanı yine kullanıcının belirleyeceği yeni sırayla yer 
değiştiriniz.
Index 1, Index 5 ise
...
// Belirtilen indeksteki elemanı taşıma
...
int main(int argc, char *argv[]) {
 	...
 	while(1){
         ...
         printf("Taşımak istediğiniz elemanın indeksini girin: ");
         scanf("%d", &index);
    
         printf("Elemanın yeni hedef indeksini girin: ");
         scanf("%d", &newIndex);
